...
Gem::Specification.new do |s|
  ...
  s.authors     = ['']
  s.email       = ''
  s.files       = ['lib/public_api_client.rb', 'lib/carserv/public_api/client/config.rb', 'lib/carserv/public_api/client/base.rb', 'lib/carserv/public_api/client/repair_order.rb', 'lib/carserv/public_api/client/rate_limiter.rb', 'lib/carserv/public_api/client/authenticator.rb']
